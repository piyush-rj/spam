...
import { useGroupsStore } from '@/app/zustand/atoms/zustand';
import { useParams } from 'next/navigation'; // Use useParams to fetch dynamic params
...
export default function UserGroups() {
  ...
  const { groups, loading, error, fetchGroups } = useGroupsStore((state) => state);

  useEffect(() => {
    if (userIdString) {
      fetchGroups(userIdString);
    }
  }, [userIdString, fetchGroups]);
