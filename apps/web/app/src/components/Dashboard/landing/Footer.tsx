      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-white text-xl font-bold">orbit</span>
            </div>
        ...
        <div className="border-t border-yellow-500/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Orbit Chat. All rights reserved.
          </p>
          <div className="flex space-x-6">
            ...
            <Link href="#cookies">
              <span className="text-gray-500 hover:text-gray-300 text-sm">Cookies</span>
            </Link>
          </div>
        </div>
      </div>
